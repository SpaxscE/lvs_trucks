...
function EFFECT:Init( data )
	...
	local Col = 120 - 80 * Scale

	particle:SetVelocity( Vel + Dir * (100 + 150 * Scale) )
	particle:SetDieTime( 0.4 - 0.1 * Scale )
	particle:SetAirResistance( 400 ) 
	particle:SetStartAlpha( 80 + 150 * Scale )
	particle:SetStartSize( 2 + 1 * Scale )
