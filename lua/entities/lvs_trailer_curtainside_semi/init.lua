...
function ENT:OnSpawn( pObj )
	...
	self:AddTrailerHitch( Vector(-0.002, 0.000, 1.126) * 40, LVS.HITCHTYPE_FEMALE )

	self:AddSupport( {
		pos = Vector(-3.316, 0.680, 0.125) * 40,
		mass = 100,
	} )
...
function ENT:SpawnWheels()
	...
	local Wheel1L = self:AddWheel( {
		pos = Vector(-6.557, 0.836, 0.533) * 40,
		mdl = WheelModel,
		mdl_ang = Angle(0, 90),
		radius = 0.542 * 40,
	} )
	...
	local Wheel2L = self:AddWheel( {
		pos = Vector(-7.853, 0.836, 0.533) * 40,
		mdl = WheelModel,
		mdl_ang = Angle(0, 90),
		radius = 0.542 * 40,
	} )
	...
	local Wheel3L = self:AddWheel( {
		pos = Vector(-9.182, 0.836, 0.533) * 40,
		mdl = WheelModel,
		mdl_ang = Angle(0, 90),
		radius = 0.542 * 40,
	} )
